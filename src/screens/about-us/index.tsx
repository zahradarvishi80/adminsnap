...
import { AboutUsApi } from "@taban/api";
import "./style.scss";
...
export const AboutUs = () => {
    ...
    const getAboutUsFromServer = () => {
        ...
        AboutUsApi.Get(user).then((data: any) => {
            setAboutUs(data.aboutUs.aboutUs);
    ...
    const editAboutUs = () => {
        ...
        setToastBg("");
        AboutUsApi.Create(user, aboutUs).then((data: any) => {
            setAboutUs(data.aboutUs.aboutUs);
        ...
        <Wrapper>
            ...
            <div className=" container ">
                <header className="d-flex flex-row">
                    <h2 className="text-center col-11"> {t("aboutUs")}</h2>
                    <Button
                ...
                >
                    <Toast.Header>
                        <img
                            ...
                            alt=""
                        />
                        <strong className="me-auto">{t("aboutUs")}</strong>
                    ...
                    <Toast.Body className="d-flex flex-row justify-content-between">
                        ...
                        {toastBg == "" ? (
                            <div className="about-send-loader"></div>
                        ) : (
                            <></>
                        )}
                    </Toast.Body>
